...
(function($) {
    $.extend({
        myTime: {
             ...
             */
            UnixToDate: function(unixTime, isHour, isDay, isYear, isFull) {
                
                var time = new Date(unixTime);
                var ymdhis = "";
												
                if(isHour === true){
                    ymdhis += " " + toDou(time.getHours()) + ":";
                    ymdhis += toDou(time.getMinutes());
                    return ymdhis;
                }
                if(isDay === true){
                    ymdhis += toDou((time.getMonth()+1)) + "-";
                    ymdhis += toDou(time.getDate())+" ";                
                    ymdhis += " " + toDou(time.getHours()) + ":";
                    ymdhis += toDou(time.getMinutes());
                    return ymdhis;
                }
                ...
                //ymdhis += time.getFullYear() + "-";
                ymdhis += toDou((time.getMonth()+1)) + "月";
                ymdhis += toDou(time.getDate())+ "日";
                if (isFull === true)
                {
                    ymdhis += " " + toDou(time.getHours()) + ":";
                    ymdhis += toDou(time.getMinutes());
                    //ymdhis += toDou(time.getSeconds());
                }
                return ymdhis;
            }
        }
