                ...
                $(".tcdPageCode").createPage({
                    ...
                    backFn: function (p) {
                        ...
                        $.ajax({
                            url: http + "queryInfo",
                            type: "POST",
                            data: JSON.stringify({"uid": u_id, "sid": s_id, "start": p,"i_state":2,"i_name":i_name}),
                            dataType: "json",
                            contentType: "application/json",
                            success: function (data) {
                                if (data.success == true) {
                ...
                $(".tcdPageCode").createPage({
                    ...
                    backFn: function (p) {
                        ...
                        $.ajax({
                            url: http + "queryInfo",
                            type: "POST",
                            data: JSON.stringify({"uid": u_id, "sid": s_id, "start": p,"i_state":2,"i_name":i_name,"c_id":c_id,"s_name":s_name}),
                            dataType: "json",
                            contentType: "application/json",
                            success: function (data) {
                                if (data.success == true) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success == true) {
                ...
                $("#list li").click(function () {
                    var iId = $(this).attr('name');
                    window.location.href = "addCommodity.html?idCK=" + iId;
                })
            } else {
                if (data.state == 1) {
                    $(".mini").show();
            ...
            $(".tcdPageCode").createPage({
                ...
                backFn: function (p) {
                    ...
                    $.ajax({
                        url: http + "queryInfo",
                        type: "POST",
                        data: JSON.stringify({"uid": u_id, "sid": s_id, "start": p,"i_state":2}),
                        dataType: "json",
                        contentType: "application/json",
                        success: function (data) {
                            if (data.success == true) {
